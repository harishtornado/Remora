...
const PromptCard = ({ post, handleTagClick, handleEdit, handleDelete }) => {
  ...
  return (
    <div className="prompt_card">
      ...
      <p 
        className="font-inter text-sm font-bold pink_gradient cursor-pointer" 
      ...
      {session?.user.id === post.creator._id && pathName === '/profile' &&(
        <div className="mt-5 w-full flex flex-row justify-around border-t border-gray-100 pt-3">
          <p 
